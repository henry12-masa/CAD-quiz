...
const quizInfo = {
  autocadProfessional: {
    ...
    desc: "作図・編集・注釈・画層・レイアウト・印刷・効率化操作"
  },
  autodeskUser: {
    title: "Autodesk Certified User",
    desc: "AutoCAD基礎操作・作図補助・修正・注釈・出力の基本"
  },
  cad2kyu: {
    title: "CAD利用技術者試験2級",
    desc: "CADシステム基礎・製図知識・図形処理・情報管理"
  },
  cad1kyu: {
    title: "CAD利用技術者試験1級",
    desc: "実務製図・機械/建築図面・寸法記入・レイヤ管理・図面読解"
  }
};
...
if (type === "all") {
  document.title = "CAD資格クイズ";
  pageTitle.textContent = "CAD資格クイズ";
  pageDesc.textContent = "4カテゴリ・各150問から50問ランダムで出題";
} else {
  const info = quizInfo[type] || quizInfo.autocadProfessional;
...
function showQuestion() {
  ...
  shuffle(q.choices).forEach(choice => {
    ...
    btn.onclick = () => {
      ...
      autoTimer = setTimeout(goNext, AUTO_NEXT_DELAY);
    };
